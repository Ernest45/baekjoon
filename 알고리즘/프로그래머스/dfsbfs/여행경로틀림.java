...
public class 여행경로틀림 {
    ...
    public static void main(String[] args) {
        ...
        String tickets1[][] = new String[][] {{"ICN", "D"}, {"D", "ICN"}, {"ICN", "B"}};

        여행경로틀림 main = new 여행경로틀림();
    ...
    public String[] solution(String[][] tickets) {
        ...
        dfs("ICN", tickets.length +1, path, hashMap);
    ...
    private void dfs(String current, int target, List<String> path,HashMap<String, PriorityQueue<String>> hashMap) {
        ...
        PriorityQueue<String> to = hashMap.get(current);
        if (to != null && !to.isEmpty()) {

            String next = to.poll();
            dfs(next, target, path, hashMap);
        }
